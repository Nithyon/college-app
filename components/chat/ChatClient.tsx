    ...
    <div className="min-h-[calc(100vh-200px)] border-t border-[var(--color-border)] bg-[var(--color-bg)] py-8">
      <CenteredContainer>
        ...
        <div className="grid gap-8 lg:grid-cols-[220px_1fr]">
          <aside className="space-y-6 font-body text-xs uppercase tracking-widest text-[var(--color-text-muted)]">
            <div>
              <p className="mb-2 text-[var(--color-text)]">Categories</p>
                ...
                {categories.map((c) => (
                  <li key={c}>
                    <button
                      ...
                      className="w-full border border-transparent py-2 text-left hover:border-[var(--color-border)]"
                    >
                      {c}
                    </button>
                  </li>
            ...
            <div>
              <p className="mb-2 text-[var(--color-text)]">Demo scenarios</p>
          ...
          <section className="space-y-4">
            <div className="max-h-[60vh] space-y-4 overflow-y-auto border border-[var(--color-border)] bg-[var(--color-bg)] p-4">
              ...
              {typing && (
                <p className="font-body text-xs text-[var(--color-text-muted)]">Typing…</p>
              )}
            </div>
            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {sttOk ? (
                  ...
                  <span className="self-center font-body text-xs text-[var(--color-text-faint)]">
                    Voice unavailable
                  </span>
                )}
                <Button
